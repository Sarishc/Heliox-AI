...
@router.post("/", response_model=UsageSnapshot, status_code=status.HTTP_201_CREATED, summary="Create a usage snapshot")
...
@router.delete("/{snapshot_id}", status_code=status.HTTP_204_NO_CONTENT, summary="Delete a usage snapshot")
