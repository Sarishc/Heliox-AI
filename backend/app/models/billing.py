...
class TeamSubscription(Base, UUIDMixin, TimestampMixin):
    ...
    current_period_start: Mapped[Optional[datetime]] = mapped_column(
        nullable=True, comment="Current billing period start"
    )

    current_period_end: Mapped[Optional[datetime]] = mapped_column(
        nullable=True, index=True, comment="Current billing period end"
    )
    ...
    canceled_at: Mapped[Optional[datetime]] = mapped_column(nullable=True, comment="When subscription was canceled")

    # Trial
    trial_start: Mapped[Optional[datetime]] = mapped_column(nullable=True, comment="Trial start date")

    trial_end: Mapped[Optional[datetime]] = mapped_column(nullable=True, comment="Trial end date")
    ...
    def __repr__(self) -> str:
        return f"<TeamSubscription(team_id={self.team_id}, plan={self.plan.value}, " f"status={self.status.value})>"
