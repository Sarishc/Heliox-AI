...
class CostSnapshot(Base, UUIDMixin, TimestampMixin):
    ...
    date: Mapped[date] = mapped_column(Date, nullable=False, comment="Date of the cost snapshot")
    ...
    gpu_type: Mapped[str] = mapped_column(String(100), nullable=False, comment="Type of GPU (e.g., A100, H100, V100)")
...
class UsageSnapshot(Base, UUIDMixin, TimestampMixin):
    ...
    date: Mapped[date] = mapped_column(Date, nullable=False, comment="Date of the usage snapshot")
