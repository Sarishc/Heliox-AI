...
class CostSnapshotBase(BaseModel):
    ...
    provider: str = Field(..., min_length=1, max_length=100, description="Cloud provider or platform")

    gpu_type: str = Field(..., min_length=1, max_length=100, description="Type of GPU")
...
class UsageSnapshotBase(BaseModel):
    ...
    gpu_hours: Decimal = Field(..., ge=0, description="Number of GPU hours used")
