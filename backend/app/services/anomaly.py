...
class AnomalyDetectionService:
    ...
    def detect(self, *, team_id: UUID) -> AnomalyResult:
        ...
        spend_series = self._daily_series(
            CostSnapshot, CostSnapshot.cost_usd, CostSnapshot.date, team_id, start_date, end_date
        )
        usage_series = self._daily_series(
            UsageSnapshot, UsageSnapshot.gpu_hours, UsageSnapshot.date, team_id, start_date, end_date
        )
        ...
        projected_monthly_spend, breach_probability = self._breach_probability(
            spend_series, budget
        )
    ...
    def _breach_probability(
        self,
        spend_series: List[tuple[date, float]],
