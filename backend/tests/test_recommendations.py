...
class TestRecommendationEngine:
    ...
    def test_idle_gpu_detection_high_severity(self):
        ...
        cost_results = [
            (
                ...
                Decimal("18140.49"),
                14,
            )  # gpu_type, provider, total_cost, days_count
        ]
        ...
        filters = RecommendationFilters(start_date=date(2026, 1, 1), end_date=date(2026, 1, 14))
    ...
    def test_savings_calculation_accuracy(self):
        ...
        filters = RecommendationFilters(start_date=date(2026, 1, 1), end_date=date(2026, 1, 7))
        result = engine.generate_recommendations(filters, allow_global=True)
        ...
        if idle_recs:
            ...
            assert (
                rec.estimated_savings_usd == expected_savings
